...
function checkInputs() {
    //esta função é apenas para remover os espaços em brancos.
    ...
    if(usernameValue === '') {
        setErrorFor(username , 'nome do usuários não pode ficar em branco')
    }
    else{
	...
	if(password2Value === '') {
		...
		setErrorFor(password2, 'As senhas não estão correspondendo');
	} else{
